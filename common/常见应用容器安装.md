...
> docker pull pgvector/pgvector:0.8.1-pg17
> docker pull --platform=arm64 pgvector/pgvector:0.8.1-pg17 

```yaml

services:
  pg:
    image: pgvector/pgvector:0.8.1-pg17 # docker hub
