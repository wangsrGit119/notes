...
docker run -d -p 17051:1935 -p 17052:80 -p 17053:554 \
-p 17054:10000 -p 17054:10000/udp -p 17055:8000 -p 17055:8000/udp \
...
--env MODE=standalone \
-e TZ="Asia/Shanghai" \
-v /home/zlm8/conf:/opt/media/conf \
zlmediakit/zlmediakit:feature-8.0
...
>
###  注意事项
 >  pritunl 启动的server的端口一定要和公网映射出去的端口一致 （ .ovpn文件可以看到具体连接端口）否则连接不上 假如你的内网 server端口9777，而pritunl配置公网ip为1.2.3.4，那么到时候远程配置中生成的连接地址就是
